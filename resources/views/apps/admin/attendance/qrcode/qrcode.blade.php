...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="table-qrcode" class="table dataTable no-footer" role="grid" aria-describedby="tableqrcode_info">
                            <thead>
                                <tr>
                                    <th>Shift Name</th>
                                    <th>Start Time</th>
    ...
    {{-- Modal --}}
    @include('apps.admin.attendance.qrcode.modals._qrcode')
@endsection
